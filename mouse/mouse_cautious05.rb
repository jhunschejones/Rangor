...
# story text
puts "You settle back down to try and hear more. The rat named Bones is "\
      "speaking again."
$stdin.gets.chomp
...
$stdin.gets.chomp
puts "\s\s\"That's enough out of you old timer!\" Bones cries, and "\
      "draws out something that sounds like a sword."
$stdin.gets.chomp

puts "The room is thrown into chaos. This sounds like a good time to leave. "\
      "You look"
puts "at the agent and he nods. You move quickly out of the hide-out and you "\
      "see"
puts "staff mice from the dumpster making their escape as well. Slipping "\
      "into the"
puts "shadows, you begin the trek back to Rangor's stronghold."
puts "\n"
