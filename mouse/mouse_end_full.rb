...
$stdin.gets.chomp
puts "His eyes light up"
puts "\s\s\"I like the way you think #{$player_name}. I will proceede with "\
"your suggestion...\""
$stdin.gets.chomp
...
$stdin.gets.chomp
puts "\s\s\"Thank you for your services #{$player_name} the mouse. My only "\
      "regret is that"
